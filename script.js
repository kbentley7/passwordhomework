...
//  Arrays for Possible Character Choices
...
// This function ask user which options and made conditional statements to ensure minimum option requirements were met.
function questions() {
  var isValid = false;
  do {
